...
public class TodayRecordItemAdapter extends BaseFastAdapter {
    private List<RecordBean.BodyBean.DataBean.ListBean> list;
    public TodayRecordItemAdapter(Context ctx, List<RecordBean.BodyBean.DataBean.ListBean> list) {
        super(ctx);
        this.list = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RecordBean.BodyBean.DataBean.ListBean listBean = list.get(position);
